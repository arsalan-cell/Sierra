...
const [show,setShow]=useState(true)
  ...
  <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      ...
      <div className="flex justify-center mt-6">
        <button className="h-12 w-40 mt-6 rounded-3xl inline-flex text-black bg-green-400  border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 text-white ">Learn More</button>
  ...
  <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
      <img class=" p-14 bg-gray-100 object-cover object-center rounded-2xl" alt="hero" src="https://sierra.keydesign.xyz/saas/wp-content/uploads/sites/3/2023/10/sass-widget-12.png"/>
    </div>
    <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
    <p className='c text-black'>Seamless workflows</p>
      <h1 class=" f mt-2 sm:text-4xl  mb-4  text-gray-900">Powerful and intuitive
        <br class="hidden lg:inline-block"/><span className='text-green-400'>automation</span> engine
      </h1>
      <p class=" b mb-8 leading-relaxed">Automate repetitive tasks,Streamline processes,and <br class="hidden lg:inline-block"/> enhance productivity without powerful tools</p>
