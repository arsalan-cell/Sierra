...
import {FreeMode, Pagination, pagination} from 'swiper/modules'
  ...
  return (
    ...
    <section>
      <div className='min-h-[100vh] border-2 hero_bg'>
        <div className=' text-white text-center mt-40 ml-18 md:flex-row items-center '>
          ...
          <div className='text-center flex sm:mb-36 gap-2 justify-center ' >

            <p className=' l mt-12  flex gap-2  '> <span className='text-green-400'><FaRegCheckCircle /></span> 3-day Free Trial</p>
            <p className=' l mt-12  flex gap-2 '> <span className='text-green-400'><FaRegCheckCircle /></span>No Credit Card</p>
            <p className=' l mt-12  flex gap-2 '> <span className='text-green-400'><FaRegCheckCircle /></span>Cancel Anytime</p>
          </div>
        </div>
            ...
            <div className="flex flex-wrap -m-4 text-center">
              <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                <div className="border-0 border-gray-200 px-4 py-6 rounded-lg">
                  <svg className="text-white mr-32 w-20 rounded-xl  bg-violet-500 hover:bg-green-400  " viewBox="0 0 20 15">
                    <PiChatsDuotone />
                  </svg>
          ...
          <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
            <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
              ...
              <h1 className="f mt-2  sm:text-4xl  mb-4  text-gray-900">Check project progress
                <br className="" />and <span className='text-green-400'>performance</span>
              </h1>
              ...
              <div className="flex justify-center mt-6">
                <button className="l gap-2 h-12 w-40 mt-6 rounded-3xl inline-flex text-black bg-green-400  border-0 py-2 px-6 focus:outline-none hover:bg-violet-500 hover:text-white ">Learn More <FaRegArrowAltCircleRight /></button>
      ...
      <div>
        <section className="text-gray-600 body-font ">
          <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center ">
            ...
            <div className="lg:flex-grow md:w-1/2 flex-wrap  lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left  ">
              <p className='c text-black'>Seamless workflows</p>
              <h1 className=" f mt-2 sm:text-3xl    mb-4  text-gray-900">Powerful and intuitive
                <br className="" /><span className='text-green-400'>automation</span> engine
              </h1>
      ...
      <div className='min-h-[180vh] border-2 hero_bg'>
          ...
          <section className="text-gray-600 body-font">
            <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
              <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                ...
                <button className=" gap-2 h-14 items-center  w-48 mt-6 rounded-3xl inline-flex text-black bg-green-400  border-0 py-2 px-6 focus:outline-none hover:bg-violet-500 hover:text-white ">Discover More<FaRegArrowAltCircleRight /></button>
        ...
        <div className='text-gray-400 flex gap-36 mt-14 text-4xl ml-28 sm:ml-auto flex flex-wrap items-center  justify-center  '>
            ...
            <div className="flex flex-wrap -m-4 ml-0  ">
              <div className="p-4  xl:w-1/3  w-full ">
                <div className=" bg-gray-100 h-full  rounded-lg  ">
                  ...
                  <button className="h-14 w-80 mt-8 mb-6 rounded-2xl  bg-white hover:bg-violet-500 hover:text-white  text-black">Purchase now</button>
              ...
              <div className="p-4 xl:w-1/3 md:w-1/2 w-full  ">
                <div className="bg-gray-100 h-full  rounded-lg  ">
                  ...
                  <button className="mb-10 h-14 w-80 mt-8 rounded-2xl  bg-green-400 hover:bg-violet-500 hover:text-white  text-black">Purchase now</button>
              ...
              <div className="p-4 xl:w-1/3 md:w-1/2 w-full ">
                <div className="bg-gray-100 h-full  rounded-lg ">
                  ...
                  <button className="mb-10 h-14 w-80 mt-8 rounded-2xl  bg-white hover:bg-violet-500 hover:text-white  text-black">Purchase now</button>
      ...
      <div className=' bg-gray-100 h-[700px] sm:h-[1100px] lg:h-[700px]'>
        <section className="">
          <div className="container mx-auto flex  py-24  md: flex-col lg:flex-row ">
            ...
            <div className='flex-row mt-20 ml-48  sm:ml-10 lg:ml-48  md:'>
              <div className='flex  '>
                <div className=' mb-12 mr-20 '>
                  <svg className="mb-4 text-white mr-32 w-20 rounded-xl  bg-violet-500 hover:bg-green-400  " viewBox="0 0 20 15">
                    <PiChatsDuotone />
                  </svg>
      ...
      <div>
        <div className="flex flex-col  w-full mb-20   lg:mt-5">
              ...
              >
                ...
                {data.map((item) =>(
                  ...
                  <SwiperSlide >
                      ...
                      <div className='bg-gray-100  py-5  h-60   justify-center items-center rounded-2xl border-2 mr-5 mt-10  '>
                        <p className=' text-gray-500 ml-5 mr-5 '>{item.description}</p>
                        <img className=' ml-36 bg-gray-100 h-10 w-20 py-2 justify-center' src='/star.png' alt="hlo" />

                      </div>
                     
                    <p className=' ml-44 mt-[-20px] mb-10  h-14  w-14 rounded-full border-4  '> <img className='rounded-full ' src={item.img} alt="my-img" /></p>
                    
                    <div className=' flex flex-col justify-center items-center  '>

                 <p className='text-1xl'>{item.name}</p>
                 <p className='mb-10 text-gray-500'>{item.position}</p>
                 </div>
                  </SwiperSlide>
      ...
      <div className='bg-gray-100'>
        <div className="flex flex-col  w-full mb-20">
          ...
          <div className=''>
            <div className=' flex h-16  mt-14 gap-6 justify-center   sm:flex-col   lg:flex-col  xl:flex-row '>
            ...
            <div className='flex h-16  mt-12 gap-6 justify-center sm:flex-col    lg:flex-col  xl:flex-row'>
              <div className='bg-white w-[600px]  rounded-2xl sm:mt-20 lg:mt-20 xl:mt-0'>
            ...
            <div className='flex h-16 mt-12 gap-6 mb-20 justify-center sm:flex-col   lg:flex-col  xl:flex-row '>
              <div className='bg-white w-[600px] rounded-2xl sm:mt-40  lg:mt-40 xl:mt-0  ' >
                <p className='mr-72 mt-5'>3.What is your cancellation policy?</p>
        ...
        <div className='min-h-[75vh]  hero_bg'>
          <div className='pt-20'>
            ...
            <div className='flex gap-2 justify-center '>
              ...
              <button className="l flex gap-3  c h-14 w-48 mt-10 rounded-3xl    bg-green-400 border-0 py-3 px-6 focus:outline-none hover:bg-violet-500 hover:text-white text-black  text-base  ">Start free trial<FaRegArrowAltCircleRight />
              </button>
        ...
        <div className='flex bg-white border-2 justify-between sm:flex-col items-center lg:flex-row    '>

          <div className=' ml-28 flex gap-4 mt-10 mb-10 sm:mr-20 '>
          ...
          <div className='flex px-10 mb-6  bg-white gap-2 justify-end '>
            ...
            <span className='g'><button className="l gap-2 inline-flex  c h-8 w-32 mt-10 rounded-3xl  bg-green-400 border-0 py-1 px-3  focus:outline-none hover:bg-violet-500 hover:text-white text-black  text-base  "><FaInstagram /><p>Instagram</p>
            </button></span>
